...
class GameMessage : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:GameMessage) */ {
 public:
  ...
  static const GameMessage* internal_default_instance();
  ...
  void UnsafeMergeFrom(const GameMessage& from);
  private:
...
extern ::google::protobuf::internal::ExplicitlyConstructed<GameMessage> GameMessage_default_instance_;
