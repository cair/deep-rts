        ...
        dataTile(dataTile)
{
    ...
    setupVerticles(tile_verticles, dataTile.getTypeId(), dataTile.width, dataTile.height, 1); // TODO firstgid always 1 ?
    setupVerticles(deplete_verticles, dataTile.getDepleteTile(), dataTile.width, dataTile.height, 1); // TODO firstgid always 1 ?

}


void GraphicTile::setupVerticles(sf::Vertex* vertices, int tId, int tileWidth, int tileHeight, int firstgid)
{
