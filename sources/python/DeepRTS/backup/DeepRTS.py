import pyDeepRTS
import sources.python.DeepRTS.util
from sources.python.DeepRTS.gui import GUI as PygameGUI
import os
import shutil
import numpy as np
...
class PyDeepRTS(pyDeepRTS.Game):
    ...
    def setup_data_files():
        ...
        sources.python.DeepRTS.util.copytree(template_data, target_data, ignore=shutil.ignore_patterns('config.json'))
