...
class Unit:
    ...
    def __init__(self, player):
        ...
        self.current_state = self.get_state(UnitC.Spawning)

        self.player = player
        self.game = player.game
        self.data = player.game.data

        self.L_Unit = self.game.L_Unit
        self.L_Tile_Collision = self.game.L_Tile_Collision
    ...
    def set_position(self, x, y):
        ...
        for tile in self.unit_area():
            self.data[tile[0]][tile[1]] = self.unit_id
    ...
    def build(self, idx):
        ...
        entity = self.buildable[idx](self.player)
