...
def adjacent_tiles(arr, i, j, d, type=const.Map.TYPE_WALKABLE):
...
def adjacent_walkable_tiles(unit, i, j, d, type=const.Map.TYPE_WALKABLE):
...
def is_walkable_tile(unit, x, y):
    tile_walkable = unit.game.data['tile'][x][y] == const.Map.ID_GRASS
